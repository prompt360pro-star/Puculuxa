...
describe('QuotationService', () => {
    ...
    describe('create', () => {
        it('should create quotation, calculate total, notify admins and return the new quotation', async () => {
            const createDto = { eventType: 'BIRTHDAY', guestCount: 50, customerName: 'Test' };
            const createdQuotation = { id: '1', ...createDto, total: 15000, status: 'PENDING' };
            ...
            expect(mockEventsGateway.notifyAdmins).toHaveBeenCalledWith('new_quotation', createdQuotation);
        });
    });

    describe('findOne', () => {
        it('should return a quotation if found', async () => {
            mockPrismaService.quotation.findUnique.mockResolvedValue({ id: '1', total: 15000 });
    ...
    describe('updateStatus', () => {
        it('should update status calling findOne to verify existence', async () => {
            ...
            mockPrismaService.quotation.update.mockResolvedValue({ id: '1', status: 'APPROVED' });
